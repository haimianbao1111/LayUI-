...
public partial class _Default : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        while (Reader.Read())
        {
            ...
            strHtmls.Append("<td style=' text-align:center;'><a href='javascript:POBrowser.openWindow(\"View.aspx?ID=" + pID + "\" ,\"width=1200px;height=800px;\");' >查看</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href='javascript:POBrowser.openWindow(\"Openfile.aspx?ID=" + pID + "\" ,\"width=1200px;height=800px;\");'>编辑</a></td>");
            strHtmls.Append("</tr>");
        }
        if (!flg)
        {
