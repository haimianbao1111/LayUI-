					...
					<tbody>
						<tr>
							...
							<td style="text-align:center;">
								<a href="javascript:POBrowser.openWindow('Edit.aspx' , 'width=1200px;height=800px;');"><span style=" color:Green;">编辑正文</span></a>&nbsp;&nbsp;&nbsp;
								<a href="javascript:POBrowser.openWindow('TaoHong.aspx' , 'width=1200px;height=800px;');"><span style=" color:Green;">套红</span></a>&nbsp;&nbsp;&nbsp;
								<a href="javascript:POBrowser.openWindow('ReadOnly.aspx' , 'width=1200px;height=800px;');"><span style=" color:Green;">正式发文</span></a>
							</td>
						</tr>
					</tbody>
				</table>
