<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Word.aspx.cs" Inherits="WordResExcel_Word" %>
...
<body>
    <div style="font-size: 12px; line-height: 20px; border-bottom: dotted 1px #ccc; border-top: dotted 1px #ccc;
        ...
        关键代码：<span style="background-color: Yellow;"> <br />PageOffice.WordWriter.DataRegion dataRegion
            ...
            <br />
            dataRegion.Value = "[excel]doc/1.xls[/excel]";</span><br />
    </div>
    <br />
